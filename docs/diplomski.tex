...
\begin{figure}[H]
  \begin{tabular}{cc}
    \subfloat[10ms]{\includegraphics[width=2.8in]{packets_lost_every_10ms.png}} &
    \subfloat[9ms]{\includegraphics[width=2.8in]{packets_lost_every_9ms.png}} \\
    \subfloat[8ms]{\includegraphics[width=2.8in]{packets_lost_every_8ms.png}} &
    \subfloat[7ms]{\includegraphics[width=2.8in]{packets_lost_every_7ms.png}} \\
    \subfloat[6ms]{\includegraphics[width=2.8in]{packets_lost_every_6ms.png}} &
    \subfloat[5ms]{\includegraphics[width=2.8in]{packets_lost_every_5ms.png}}
  \end{tabular}
...
Dodatno, provedena su duža mjerenja kada je interval očitanja 5ms. Jedno gdje je broj očitanja bio 20`000 i dva gdje je broj očitanja bio 50`000.
Još jedno mjerenje provedeno je sa intervalom očitanja 6ms, ali u ovoj situaciji, autor rada je udaljavao i približavao ugradbeno računao od računala dok se provodilo mjerenje.
Slika \ref{fig:packet_loss_2} prikazuje ta mjerenja.
Na slici \ref{fig:packet_loss_2} se može primijetiti da broj izgubljenih paketa raste ako se mikroupravljač udaljava od računala.

\begin{figure}[H]
  \begin{tabular}{cc}
    \subfloat[5ms]{\includegraphics[width=2.8in]{packets_lost_every_5ms_20k.png}} &
    \subfloat[5ms]{\includegraphics[width=2.8in]{packets_lost_every_5ms_50k.png}} \\
    \subfloat[5ms]{\includegraphics[width=2.8in]{packets_lost_every_5ms_50k_v2.png}} &
    \subfloat[6ms uz udaljavanje]{\includegraphics[width=2.8in]{packets_lost_every_6ms_with_walking.png}}
  \end{tabular}
...
\begin{figure}[H]
  \begin{tabular}{cc}
    \subfloat[10ms]{\includegraphics[width=2.8in]{q_full_ro_every_10ms.png}} &
    \subfloat[9ms]{\includegraphics[width=2.8in]{q_full_ro_every_9ms.png}} \\
    \subfloat[8ms]{\includegraphics[width=2.8in]{q_full_ro_every_8ms.png}} &
    \subfloat[7ms]{\includegraphics[width=2.8in]{q_full_ro_every_7ms.png}} \\
    \subfloat[6ms]{\includegraphics[width=2.8in]{q_full_ro_every_6ms.png}} &
    \subfloat[5ms]{\includegraphics[width=2.8in]{q_full_ro_every_5ms.png}} \\
  \end{tabular}
  \caption{Broj elementa u strukturi koja ima oblik reda uzevši u obzir interval očitavanja podataka}
  \label{fig:q_full}
\end{figure}
Može se primijetiti da broj elementa ostaje minimalan sve dok interval očitavanja nije kraći od 6 milisekundi.

Provedena su dva dodatna mjerenja s intervalom očitanja od 5ms, jedno mjerenje s intervalom očitanja od 4ms i jedno mjerenje s intervalom očitanja 6ms uz udaljavanje i približivanjem mikroupravljača od računala dok se provodilo mjerenje.
Slika \ref{fig:q_full_1} prikazuje ta mjerenja.

\begin{figure}[H]
  \begin{tabular}{cc}
    \subfloat[5ms]{\includegraphics[width=2.8in]{q_full_ro_every_5ms_v2.png}} &
    \subfloat[5ms]{\includegraphics[width=2.8in]{q_full_ro_every_5ms_v3.png}} \\
    \subfloat[4ms]{\includegraphics[width=2.8in]{q_full_ro_every_4ms.png}} &
    \subfloat[6ms uz udaljavanje]{\includegraphics[width=2.8in]{q_full_ro_every_6ms_with_walking.png}}
  \end{tabular}
  \caption{Broj izgubljenih paketa uz brzinu očitanja podataka od 5ms i 6ms}
  \label{fig:q_full_1}
\end{figure}
