...
#define LPS22HB_DriverVersion_Point (uint8_t)0/** @defgroup LPS22HB_Exported_Constants
* @{
*//**
...
#define LPS22HB_CTE_MASK           (uint8_t)0x20/** @defgroup LPS22HB_Exported_Functions
* @{
*/
...
* @retval Error Code [LPS22HB_ERROR, LPS22HB_OK]
*/
LPS22HB_Error_et LPS22HB_Set_I2C(void *handle, LPS22HB_State_et i2cstate);/*CTRL_REG3 Interrupt Control*/
/**
