...
status_t LSM6DSM_ACC_GYRO_SH0_ReadMem(void *handle, u8_t SlvAddr, u8_t Reg, u8_t *Bufp, u8_t len, u8_t stop)
{
  ...
  while(op_cmpl != LSM6DSM_ACC_GYRO_SENS_HUB_END_OP_COMPLETED);  /* Read the result */
...
status_t LSM6DSM_ACC_GYRO_SH0_WriteByte(void *handle, u8_t SlvAddr, u8_t Reg, u8_t Bufp)
{
  ...
  /* Stop everything */
  LSM6DSM_ACC_GYRO_W_FUNC_EN(handle, LSM6DSM_ACC_GYRO_FUNC_EN_DISABLED);
  LSM6DSM_ACC_GYRO_W_I2C_MASTER_Enable(handle, LSM6DSM_ACC_GYRO_MASTER_ON_DISABLED);  return MEMS_SUCCESS;
}
