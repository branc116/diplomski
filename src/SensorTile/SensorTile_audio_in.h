...
#define DEFAULT_AUDIO_IN_VOLUME               64  /** @defgroup SENSORTILE_AUDIO_IN_Exported_Variables SENSORTILE_AUDIO_IN Exported Variables
   */
  extern DMA_HandleTypeDef hdma_dfsdmReg_FLT[];  /** @defgroup SENSORTILE_AUDIO_IN_Exported_Macros SENSORTILE_AUDIO_IN Exported Macros
