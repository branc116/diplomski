...
} SD_CardInfo;/** @defgroup SENSORTILE_SD_Exported_Constants SENSORTILE_SD Exported Constants
   */    /**
...
#endif /* __SENSORTILE_SD_H *//************************ (C) COPYRIGHT STMicroelectronics *****END OF FILE****/
